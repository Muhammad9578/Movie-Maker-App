...
//        intentList = addIntentsToList(context, intentList, pickIntent);
     ...
     * @return image.
     */
    public static Uri getImageFromResult(Context context, int requestCode, int resultCode,
    ...
    private static Bitmap decodeBitmap(Context context, Uri theUri, int sampleSize) {
        ...
        try {
            ...
            bitmap_height = actuallyUsableBitmap.getHeight();
            bitmap_width = actuallyUsableBitmap.getWidth();
