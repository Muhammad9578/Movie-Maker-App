...
import com.creativetechnologies.slideshows.videos.songs.videomaker.mask.ThreeDMaskBitmapEffect.EFFECT;

import java.util.ArrayList;

public enum THREEDTHEMES {
    Shine("Shine") {
