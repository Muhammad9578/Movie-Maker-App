 ...
 */
public abstract class EndSticker {
    protected static final String TAG = "EndSticker";
    ...
    public boolean contains(float x, float y) {
        ...
        return EndStickerUtils.trapToRect(unrotatedWrapperCorner).contains(unrotatedPoint[0], unrotatedPoint[1]);
    }
