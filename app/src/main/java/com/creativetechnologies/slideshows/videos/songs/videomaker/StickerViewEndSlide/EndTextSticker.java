...
public class EndTextSticker extends EndSticker {
    ...
    public EndTextSticker(Context context) {
        this(context, null);
    }

    public EndTextSticker(Context context, Drawable drawable) {
        mContext = context;
        mDrawable = drawable;
        if (drawable == null) {
    ...
    public EndTextSticker addText(Context context, EndTextSticker textSticker, String text, int color, int size, Typeface typeface) {
        textSticker.setDrawable(ContextCompat.getDrawable(context,
                R.drawable.transparent_background));
        textSticker.setText(text);
        textSticker.setTextColor(color);
        textSticker.setMaxTextSize(size);
    ...
    public void resizeText() {
        ...
        mStaticLayout = new StaticLayout(mText,
                mTextPaint,
                mTextRect.width(),
                mAlignment,
                mLineSpacingMultiplier,
