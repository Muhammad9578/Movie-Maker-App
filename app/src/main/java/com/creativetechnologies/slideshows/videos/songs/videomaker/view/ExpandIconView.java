package com.creativetechnologies.slideshows.videos.songs.videomaker.view;
...
public class ExpandIconView extends View {
    ...
    public ExpandIconView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            this.switchColor = array.getBoolean(array.getIndex(1), false);
            this.color = array.getColor(array.getIndex(2), -1);
            this.colorMore = array.getColor(array.getIndex(3), -1);
            this.colorLess = array.getColor(array.getIndex(4), -1);
            long animationDuration = (long) array.getInteger(array.getIndex(5), 150);
            this.padding = array.getDimensionPixelSize(array.getIndex(6), -1);
